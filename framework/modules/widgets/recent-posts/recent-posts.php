...
class DessauSelectRecentPosts extends DessauSelectWidget {
	public function __construct() {
		parent::__construct(
			'qodef_recent_posts',
			esc_html__( 'Dessau Recent Posts', 'dessau' ),
			array( 'description' => esc_html__( 'Select recent posts that you would like to display', 'dessau' ) )
		);
	...
	public function widget( $args, $instance ) {
        ...
        if ( $query->have_posts() ) {
            ...
            $html .= esc_html__('Sorry, there are no posts matching your criteria', 'dessau');
        }
