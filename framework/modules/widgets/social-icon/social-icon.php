...
class DessauSelectSocialIconWidget extends DessauSelectWidget {
	
	public function __construct() {
		parent::__construct(
			'qodef_social_icon_widget',
			esc_html__( 'Dessau Social Icon Widget', 'dessau' ),
			array( 'description' => esc_html__( 'Add social network icons to widget areas', 'dessau' ) )
		);
	...
	protected function setParams() {
		$this->params = array_merge(
			dessau_select_icon_collections()->getSocialIconWidgetParamsArray(),
			array(
				array(
					'type'  => 'textfield',
					'name'  => 'link',
	...
	public function widget( $args, $instance ) {
		...
		<a class="qodef-social-icon-widget-holder qodef-icon-has-hover" <?php echo dessau_select_get_inline_attr( $hover_color, 'data-hover-color' ); ?> <?php dessau_select_inline_style( $icon_styles ) ?> href="<?php echo esc_url( $link ); ?>" target="<?php echo esc_attr( $target ); ?>">
