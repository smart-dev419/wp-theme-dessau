<?php
if($show_header_top) {
	do_action('dessau_select_before_header_top');
	?>
	...
	<div class="qodef-top-bar">
		<?php do_action( 'dessau_select_after_header_top_html_open' ); ?>
		...
		<?php do_action( 'dessau_select_before_header_top_html_close' ); ?>
	</div>
	
	<?php do_action('dessau_select_after_header_top');
}