...
if ( ! function_exists( 'dessau_select_mobile_header_options_map' ) ) {
	function dessau_select_mobile_header_options_map() {
		
		dessau_select_add_admin_page(
			array(
				'slug'  => '_mobile_header',
				'title' => esc_html__( 'Mobile Header', 'dessau' ),
				'icon'  => 'fa fa-mobile'
			)
		);
		
		$panel_mobile_header = dessau_select_add_admin_panel(
			array(
				'title' => esc_html__( 'Mobile Header', 'dessau' ),
		...
		$mobile_header_group = dessau_select_add_admin_group(
			array(
				'parent' => $panel_mobile_header,
				'name'   => 'mobile_header_group',
				'title'  => esc_html__( 'Mobile Header Styles', 'dessau' )
			)
		);
		
		$mobile_header_row1 = dessau_select_add_admin_row(
			array(
		...
		dessau_select_add_admin_field(
			array(
				...
				'type'   => 'colorsimple',
				'label'  => esc_html__( 'Border Bottom Color', 'dessau' ),
				'parent' => $mobile_header_row1
			)
		);
		
		$mobile_menu_group = dessau_select_add_admin_group(
			array(
				'parent' => $panel_mobile_header,
				'name'   => 'mobile_menu_group',
				'title'  => esc_html__( 'Mobile Menu Styles', 'dessau' )
			)
		);
		
		$mobile_menu_row1 = dessau_select_add_admin_row(
			array(
		...
		dessau_select_add_admin_field(
			array(
				...
				'type'   => 'colorsimple',
				'label'  => esc_html__( 'Menu Item Separator Color', 'dessau' ),
				'parent' => $mobile_menu_row1
			)
		);
		...
		dessau_select_add_admin_field(
			array(
				...
				'type'        => 'text',
				'label'       => esc_html__( 'Logo Height For Mobile Header', 'dessau' ),
				'description' => esc_html__( 'Define logo height for screen size smaller than 1024px', 'dessau' ),
				'parent'      => $panel_mobile_header,
				'args'        => array(
					'col_width' => 3,
					'suffix'    => 'px'
		...
		dessau_select_add_admin_field(
			array(
				...
				'type'        => 'text',
				'label'       => esc_html__( 'Logo Height For Mobile Devices', 'dessau' ),
				'description' => esc_html__( 'Define logo height for screen size smaller than 480px', 'dessau' ),
				'parent'      => $panel_mobile_header,
				'args'        => array(
					'col_width' => 3,
					'suffix'    => 'px'
		...
		$first_level_group = dessau_select_add_admin_group(
			array(
				...
				'title'       => esc_html__( '1st Level Menu', 'dessau' ),
				'description' => esc_html__( 'Define styles for 1st level in Mobile Menu Navigation', 'dessau' )
			)
		);
		...
		$second_level_group = dessau_select_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Dropdown Menu', 'dessau' ),
				'description' => esc_html__( 'Define styles for drop down menu items in Mobile Menu Navigation', 'dessau' )
			)
		);
		...
		dessau_select_add_admin_section_title(
			array(
				...
				'parent' => $panel_mobile_header,
				'title'  => esc_html__( 'Mobile Menu Opener', 'dessau' )
			)
		);
		...
		dessau_select_add_admin_field(
			array(
				...
				'type'        => 'text',
				'label'       => esc_html__( 'Mobile Navigation Title', 'dessau' ),
				'description' => esc_html__( 'Enter title for mobile menu navigation', 'dessau' ),
				'parent'      => $panel_mobile_header,
				'args'        => array(
					'col_width' => 3
				)
		...
		dessau_select_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Select Mobile Navigation Icon Source', 'dessau' ),
		...
		$mobile_icon_pack_container = dessau_select_add_admin_container(
			array(
				'parent'          => $panel_mobile_header,
		...
		dessau_select_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Mobile Navigation Icon Pack', 'dessau' ),
				'description'   => esc_html__( 'Choose icon pack for mobile navigation icon', 'dessau' ),
				'options'       => dessau_select_icon_collections()->getIconCollectionsExclude( array( 'linea_icons', 'dripicons', 'simple_line_icons' ) )
			)
		);

		$mobile_icon_svg_path_container = dessau_select_add_admin_container(
			array(
				'parent'          => $panel_mobile_header,
		...
		dessau_select_add_admin_field(
			array(
				...
				'label'       => esc_html__( 'Mobile Navigation Icon SVG Path', 'dessau' ),
				'description' => esc_html__( 'Enter your mobile navigation icon SVG path here. Please remove version and id attributes from your SVG path because of HTML validation', 'dessau' ),
			)
		);
		...
		dessau_select_add_admin_field(
			array(
				...
				'type'   => 'color',
				'label'  => esc_html__( 'Mobile Navigation Icon Color', 'dessau' ),
				'parent' => $panel_mobile_header
			)
		);
		...
		dessau_select_add_admin_field(
			array(
				...
				'type'   => 'color',
				'label'  => esc_html__( 'Mobile Navigation Icon Hover Color', 'dessau' ),
				'parent' => $panel_mobile_header
			)
		);
	}
	
	add_action( 'dessau_select_options_map', 'dessau_select_mobile_header_options_map', 5 );
}