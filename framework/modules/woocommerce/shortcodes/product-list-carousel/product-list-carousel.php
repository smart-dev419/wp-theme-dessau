...
namespace DessauCore\CPT\Shortcodes\ProductListCarousel;
...
class ProductListCarousel implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Product List - Carousel', 'dessau' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Number Of Visible Items', 'dessau' ),
							'value'       => array(
								esc_html__( 'One', 'dessau' )   => '1',
								esc_html__( 'Two', 'dessau' )   => '2',
								esc_html__( 'Three', 'dessau' ) => '3',
								esc_html__( 'Four', 'dessau' )  => '4',
								esc_html__( 'Five', 'dessau' )  => '5',
								esc_html__( 'Six', 'dessau' )   => '6'
							),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'dessau' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'slider_loop',
							'heading'     => esc_html__( 'Enable Slider Loop', 'dessau' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Autoplay', 'dessau' ),
							'value'       => array_flip( dessau_select_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'dessau' )
						),
						array(
							...
							'heading'     => esc_html__( 'Slide Duration', 'dessau' ),
							'description' => esc_html__( 'Default value is 5000 (ms)', 'dessau' ),
							'group'       => esc_html__( 'Slider Settings', 'dessau' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'slider_speed_animation',
							'heading'     => esc_html__( 'Slide Animation Duration', 'dessau' ),
							'description' => esc_html__( 'Speed of slide animation in milliseconds. Default value is 600.', 'dessau' ),
							'group'       => esc_html__( 'Slider Settings', 'dessau' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'slider_navigation',
							'heading'     => esc_html__( 'Enable Slider Navigation Arrows', 'dessau' ),
							'value'       => array_flip( dessau_select_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'dessau' )
						),
						array(
							...
							'heading'    => esc_html__( 'Slider Navigation Skin', 'dessau' ),
							'value'      => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Pagination', 'dessau' ),
							'value'       => array_flip( dessau_select_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'dessau' )
						),
						array(
							...
							'heading'    => esc_html__( 'Slider Pagination Skin', 'dessau' ),
							'value'      => array(
								esc_html__( 'Default', 'dessau' ) => 'default',
								esc_html__( 'Light', 'dessau' )   => 'light'
							),
						...
						array(
							...
							'heading'    => esc_html__( 'Slider Pagination Position', 'dessau' ),
							'value'      => array(
								esc_html__( 'Below Carousel', 'dessau' )  => 'bellow-slider',
								esc_html__( 'Inside Carousel', 'dessau' ) => 'inside-slider'
							),
							'dependency' => array( 'element' => 'slider_pagination', 'value' => array( 'yes' ) ),
							'group'      => esc_html__( 'Slider Settings', 'dessau' )
						),
						...
						array(
							...
							'heading'    => esc_html__( 'Button Skin', 'dessau' ),
							'value'      => array(
								esc_html__( 'Default', 'dessau' ) => 'default',
								esc_html__( 'Light', 'dessau' )   => 'light',
	...
	public function render( $atts, $content = null ) {
		...
		$html = dessau_select_get_woo_shortcode_module_template_part( 'templates/product-list', 'product-list-carousel', $params['type'], $params, $additional_params );
