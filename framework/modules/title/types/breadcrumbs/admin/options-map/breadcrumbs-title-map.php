...
if ( ! function_exists('dessau_select_breadcrumbs_title_type_options_map') ) {
	function dessau_select_breadcrumbs_title_type_options_map($panel_typography) {
		
		dessau_select_add_admin_section_title(
			array(
				'name'   => 'type_section_breadcrumbs',
				'title'  => esc_html__( 'Breadcrumbs', 'dessau' ),
				'parent' => $panel_typography
			)
		);
	
		$group_page_breadcrumbs_styles = dessau_select_add_admin_group(
			array(
				'name'        => 'group_page_breadcrumbs_styles',
				'title'       => esc_html__( 'Breadcrumbs', 'dessau' ),
				'description' => esc_html__( 'Define styles for page breadcrumbs', 'dessau' ),
				'parent'      => $panel_typography
			)
		);
	
			$row_page_breadcrumbs_styles_1 = dessau_select_add_admin_row(
				array(
			...
			$row_page_breadcrumbs_styles_2 = dessau_select_add_admin_row(
				array(
			...
			$row_page_breadcrumbs_styles_3 = dessau_select_add_admin_row(
				array(
	...
	add_action( 'dessau_select_additional_title_typography_options_map', 'dessau_select_breadcrumbs_title_type_options_map');
}