<?php
namespace DessauCore\CPT\Shortcodes\BlogSlider;
...
class BlogSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Blog Slider', 'dessau' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					array(
						...
						'value'       => array(
							esc_html__( 'Slider', 'dessau' )            => 'slider',
							esc_html__( 'Carousel', 'dessau' )          => 'carousel',
							esc_html__( 'Carousel Centered', 'dessau' ) => 'carousel-centered'
						),
						'save_always' => true
					),
					array(
	...
	public function render( $atts, $content = null ) {
		...
		dessau_select_get_module_template_part( 'shortcodes/blog-slider/holder', 'blog', '', $params );
