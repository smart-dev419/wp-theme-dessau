<?php
namespace DessauCore\CPT\Shortcodes\BlogList;
...
class BlogList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Blog List', 'dessau' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					array(
						...
						'value'       => array(
							...
							esc_html__( 'Boxed', 'dessau' )    => 'boxed',
							esc_html__( 'Masonry', 'dessau' )  => 'masonry',
							esc_html__( 'Simple', 'dessau' )   => 'simple',
							esc_html__( 'Minimal', 'dessau' )  => 'minimal'
						),
						'save_always' => true
					),
					array(
						...
						'heading'    => esc_html__( 'Number of Posts', 'dessau' )
					),
					array(
						'type'       => 'dropdown',
					...
					array(
						'type'        => 'autocomplete',
						'param_name'  => 'category',
						'heading'     => esc_html__( 'Category', 'dessau' ),
						'description' => esc_html__( 'Enter one category slug (leave empty for showing all categories)', 'dessau' )
					),
					array(
						'type'       => 'dropdown',
						'param_name' => 'image_size',
						'heading'    => esc_html__( 'Image Size', 'dessau' ),
						'value'      => array(
							...
							esc_html__( 'Thumbnail', 'dessau' ) => 'thumbnail',
					...
					array(
						...
						'group'      => esc_html__( 'Post Info', 'dessau' )
					),
					array(
						'type'       => 'dropdown',
					...
					array(
						...
						'heading'     => esc_html__( 'Text Length', 'dessau' ),
						'description' => esc_html__( 'Number of words', 'dessau' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Image', 'dessau' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Section', 'dessau' ),
						'value'      => array_flip( dessau_select_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'type', 'value'   => array( 'standard', 'boxed', 'masonry' ) ),
						'group'      => esc_html__( 'Post Info', 'dessau' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Author', 'dessau' ),
						'value'      => array_flip( dessau_select_get_yes_no_select_array( false, true ) ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Date', 'dessau' ),
						'value'      => array_flip( dessau_select_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'dessau' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Category', 'dessau' ),
						'value'      => array_flip( dessau_select_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'dessau' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Comments', 'dessau' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Like', 'dessau' ),
						'value'      => array_flip( dessau_select_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'dessau' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Share', 'dessau' ),
						'value'      => array_flip( dessau_select_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'dessau' )
					),
					array(
						...
						'heading'    => esc_html__( 'Pagination Type', 'dessau' ),
						'value'      => array(
							esc_html__( 'None', 'dessau' )            => 'no-pagination',
							esc_html__( 'Standard', 'dessau' )        => 'standard-shortcodes',
							esc_html__( 'Load More', 'dessau' )       => 'load-more',
							esc_html__( 'Infinite Scroll', 'dessau' ) => 'infinite-scroll'
						),
						'group'      => esc_html__( 'Additional Features', 'dessau' )
					)
				)
			)
		);
	...
	public function render( $atts, $content = null ) {
		...
		dessau_select_get_module_template_part( 'shortcodes/blog-list/holder', 'blog', $params['type'], $params );
	...
	public function blogCategoryAutocompleteSuggester( $query ) {
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				...
				$data['label'] = ( ( strlen( $value['category_title'] ) > 0 ) ? esc_html__( 'Category', 'dessau' ) . ': ' . $value['category_title'] : '' );
				$results[]     = $data;
			}
		}
		...
		if ( ! empty( $query ) ) {
			...
			if ( is_object( $category ) ) {
				...
				if ( ! empty( $category_title ) ) {
					$category_title_display = esc_html__( 'Category', 'dessau' ) . ': ' . $category_title;
				}
