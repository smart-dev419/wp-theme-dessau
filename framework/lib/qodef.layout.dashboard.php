...
/*
   Class: DessauSelectDashboardForm
   A class that initializes Select Dashboard Container
*/
class DessauSelectDashboardForm implements iDessauSelectLayoutNode, iDessauSelectRender {
	public $children;
	public $name;
	public $form_id;
	public $form_method;
...
/*
   Class: DessauSelectDashboardGroup
   A class that initializes DessauSelect Group Field
*/
class DessauSelectDashboardGroup implements iDessauSelectLayoutNode, iDessauSelectRender{
	public $children;
	public $name;
	public $title;
	public $description;
...
/*
   Class: DessauSelectDashboardTitle
   A class that initializes Dashboard Title
*/
class DessauSelectDashboardTitle implements iDessauSelectRender {
	private $name;
	private $title;
...
/*
   Class: DessauSelectDashboardField
   A class that initializes DessauSelect Front Field
*/

class DessauSelectDashboardField implements iDessauSelectRender {
	private $type;
	private $name;
	private $label;
	private $description;
...
abstract class DessauSelectDashboardFieldType {
	abstract public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = "" );
}

class DessauSelectDashboardFieldText extends DessauSelectDashboardFieldType {
...
class DessauSelectDashboardFieldTextArea extends DessauSelectDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
...
class DessauSelectDashboardFieldImage extends DessauSelectDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
        $class = '';
			...
			<div class="qodef-dashboard-gallery-holder">
				<ul class="qodef-dashboard-gallery-images-holder">
					<?php if ( isset($value_html) ) { 
						print dessau_select_get_module_part($value_html);
					} ?>
				</ul>
				<div class="qodef-dashboard-gallery-uploader">
					<?php 
					if ( dessau_membership_theme_installed() ) {
						echo dessau_select_get_button_html( array(
							'text'      => esc_html__( 'Upload', 'dessau' ),
							'custom_class' => 'qodef-dashboard-gallery-upload'
						) );
					} else {
						echo '<a itemprop="url" href="#" class="qodef-btn qodef-btn-medium qodef-btn-solid qodef-dashboard-gallery-upload"><span class="qodef-btn-text">' . esc_html__( 'Upload', 'dessau' ) . '</span></a>';
					} ?>
					...
					<?php if ($value !== '' && $value !== false) { ?>
						<button class="qodef-btn qodef-btn-solid qodef-dashboard-remove-image"><?php esc_html_e('Remove Media','dessau'); ?></button>
					<?php } ?>
				</div>
			</div>
		</div>
...
class DessauSelectDashboardFieldGallery extends DessauSelectDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
        $class = '';
...
class DessauSelectDashboardFieldSelect extends DessauSelectDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
        $class = '';
...
class DessauSelectDashboardFieldDate extends DessauSelectFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
        if (!empty($repeat) && array_key_exists('name', $repeat) && array_key_exists('index', $repeat)) {
			$id		= $name . '-' . $repeat['index'];
			$name	= $repeat['name'] . '['.$repeat['index'].']['. $name .']';
...
class DessauSelectDashboardFieldIcon extends DessauSelectDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$options           = dessau_select_icon_collections()->getIconCollectionsEmpty();
...
class DessauSelectDashboardFieldColor extends DessauSelectDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
        if (!empty($repeat) && array_key_exists('name', $repeat) && array_key_exists('index', $repeat)) {
			$id		= $name . '-' . $repeat['index'];
			$name	= $repeat['name'] . '['.$repeat['index'].']['. $name .']';
...
class DessauSelectDashboardFieldCheckBoxGroup extends DessauSelectDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
...
class DessauSelectDashboardFieldAddress extends DessauSelectFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
		if ( isset( $args["col_width"] ) ) {
			$col_width = $args["col_width"];
...
class DessauSelectDashboardRepeater implements iDessauSelectRender {
	private $label;
	private $description;
	private $name;
	private $fields;
			...
			<?php if ($this->table_layout) { ?>
				<div class="qodef-dashboard-repeater-table-heading">
					<div class="qodef-dashboard-repeater-fields-holder">
						<div class="qodef-dashboard-repeater-table-cell qodef-dashboard-repeater-sort"><?php esc_html_e( 'Order', 'dessau' ) ?></div>
						...
						<div class="qodef-dashboard-repeater-table-cell qodef-dashboard-repeater-remove"><?php esc_html_e( 'Remove', 'dessau' ) ?></div>
					</div>
				</div>
			<?php } ?>
...
class DessauSelectDashboardFieldFactory {
	public function render( $field_type, $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array()) {
		switch ( strtolower( $field_type ) ) {
			case 'text':
				$field = new DessauSelectDashboardFieldText();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'textarea':
				$field = new DessauSelectDashboardFieldTextArea();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'date':
				$field = new DessauSelectDashboardFieldDate();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'image':
				$field = new DessauSelectDashboardFieldImage();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'gallery':
				$field = new DessauSelectDashboardFieldGallery();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'select':
				$field = new DessauSelectDashboardFieldSelect();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'icon':
				$field = new DessauSelectDashboardFieldIcon();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'color':
				$field = new DessauSelectDashboardFieldColor();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'checkboxgroup':
				$field = new DessauSelectDashboardFieldCheckBoxGroup();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'address':
				$field = new DessauSelectDashboardFieldAddress();
