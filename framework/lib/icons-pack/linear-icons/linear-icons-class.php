...
if ( ! function_exists( 'dessau_select_add_linear_icon_pack' ) ) {
	function dessau_select_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new DessauSelectLinearIcons( 'Linear Icons', 'linear_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'dessau_select_add_icon_pack_into_collection', 'dessau_select_add_linear_icon_pack' );
}

if ( ! function_exists( 'dessau_select_add_linear_icon_pack_option' ) ) {
	function dessau_select_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'dessau' );
		
		return $options;
	}
	
	add_filter( 'dessau_select_add_icon_pack_into_options', 'dessau_select_add_linear_icon_pack_option' );
}

class DessauSelectLinearIcons implements iDessauSelectIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
