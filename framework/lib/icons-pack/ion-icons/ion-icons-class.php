...
if ( ! function_exists( 'dessau_select_add_ion_icon_pack' ) ) {
	function dessau_select_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new DessauSelectIonIcons( 'Ion Icons', 'ion_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'dessau_select_add_icon_pack_into_collection', 'dessau_select_add_ion_icon_pack' );
}

if ( ! function_exists( 'dessau_select_add_ion_icon_pack_option' ) ) {
	function dessau_select_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'dessau' );
		
		return $options;
	}
	
	add_filter( 'dessau_select_add_icon_pack_into_options', 'dessau_select_add_ion_icon_pack_option' );
	add_filter( 'dessau_select_add_icon_pack_into_social_options', 'dessau_select_add_ion_icon_pack_option' );
}

class DessauSelectIonIcons implements iDessauSelectIconCollection {
	public $icons;
	public $socialIcons;
    public $title;
	public $param;
