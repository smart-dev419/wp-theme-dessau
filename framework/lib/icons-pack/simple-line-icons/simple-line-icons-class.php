...
if ( ! function_exists( 'dessau_select_add_simple_line_icon_pack' ) ) {
	function dessau_select_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new DessauSelectSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'dessau_select_add_icon_pack_into_collection', 'dessau_select_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'dessau_select_add_simple_line_icon_pack_option' ) ) {
	function dessau_select_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'dessau' );
		
		return $options;
	}
	
	add_filter( 'dessau_select_add_icon_pack_into_options', 'dessau_select_add_simple_line_icon_pack_option' );
	add_filter( 'dessau_select_add_icon_pack_into_social_options', 'dessau_select_add_simple_line_icon_pack_option' );
}

class DessauSelectSimpleLineIcons implements iDessauSelectIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'dessau'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'dessau'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'dessau'),
            'icon-social-facebook'    => esc_html__('Facebook', 'dessau'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'dessau'),
            'icon-social-github'      => esc_html__('Github', 'dessau'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'dessau'),
            'icon-social-instagram'   => esc_html__('Instagram', 'dessau'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'dessau'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'dessau'),
            'icon-social-reddit'      => esc_html__('Reddit', 'dessau'),
            'icon-social-skype'       => esc_html__('Skype', 'dessau'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'dessau'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'dessau'),
            'icon-social-spotify'     => esc_html__('Spotify', 'dessau'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'dessau'),
            'icon-social-twitter'     => esc_html__('Twitter', 'dessau'),
            'icon-social-youtube'     => esc_html__('Youtube', 'dessau')
        );
    }
