...
if ( ! function_exists( 'dessau_select_add_linea_icon_pack' ) ) {
	function dessau_select_add_linea_icon_pack( $iconCollections ) {
		$iconCollections['linea_icons'] = new DessauSelectLineaIcons( 'Linea Icons', 'linea_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'dessau_select_add_icon_pack_into_collection', 'dessau_select_add_linea_icon_pack' );
}

if ( ! function_exists( 'dessau_select_add_linea_icon_pack_option' ) ) {
	function dessau_select_add_linea_icon_pack_option( $options ) {
		$options['linea_icons'] = esc_html__( 'Linea Icons', 'dessau' );
		
		return $options;
	}
	
	add_filter( 'dessau_select_add_icon_pack_into_options', 'dessau_select_add_linea_icon_pack_option' );
}

class DessauSelectLineaIcons implements iDessauSelectIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
