...
if ( ! function_exists( 'dessau_select_add_font_awesome_icon_pack' ) ) {
	function dessau_select_add_font_awesome_icon_pack( $iconCollections ) {
		$iconCollections['font_awesome'] = new DessauSelectIconsFontAwesome( 'Font Awesome', 'fa_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'dessau_select_add_icon_pack_into_collection', 'dessau_select_add_font_awesome_icon_pack' );
}

if ( ! function_exists( 'dessau_select_add_font_awesome_icon_pack_option' ) ) {
	function dessau_select_add_font_awesome_icon_pack_option( $options ) {
		$options['font_awesome'] = esc_html__( 'Font Awesome', 'dessau' );
		
		return $options;
	}
	
	add_filter( 'dessau_select_add_icon_pack_into_options', 'dessau_select_add_font_awesome_icon_pack_option' );
	add_filter( 'dessau_select_add_icon_pack_into_social_options', 'dessau_select_add_font_awesome_icon_pack_option' );
}

class DessauSelectIconsFontAwesome implements iDessauSelectIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
