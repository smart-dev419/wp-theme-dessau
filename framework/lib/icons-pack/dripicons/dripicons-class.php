...
if ( ! function_exists( 'dessau_select_add_dripicons_icon_pack' ) ) {
	function dessau_select_add_dripicons_icon_pack( $iconCollections ) {
		$iconCollections['dripicons'] = new DessauSelectDripicons( 'Dripicons', 'dripicon' );
		
		return $iconCollections;
	}
	
	add_filter( 'dessau_select_add_icon_pack_into_collection', 'dessau_select_add_dripicons_icon_pack' );
}

if ( ! function_exists( 'dessau_select_add_dripicons_icon_pack_option' ) ) {
	function dessau_select_add_dripicons_icon_pack_option( $options ) {
		$options['dripicons'] = esc_html__( 'Dripicons', 'dessau' );
		
		return $options;
	}
	
	add_filter( 'dessau_select_add_icon_pack_into_options', 'dessau_select_add_dripicons_icon_pack_option' );
}

class DessauSelectDripicons implements iDessauSelectIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
